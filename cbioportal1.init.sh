...
set -x
stage=$1
if [ -z $1 ]; then echo "input a stage: run_mysql, pop_mysql, build_cbio, or run_cbio"; exit; fi
...
docker_cbio_source="https://github.com/chaelir/cbioportal-docker.git" #currently at v1.17
